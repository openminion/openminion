...
class TestDetectAnomaly:
    def test_error_status_triggers_score_1(self):
        ...
        score = detect_anomaly(result=result, history=[], tool_name="file.read")
    ...
    def test_empty_unexpected_triggers_score_07(self):
        ...
        score = detect_anomaly(result=result, history=[prior], tool_name="file.read")
    ...
    def test_size_deviation_triggers_score_05(self):
        ...
        score = detect_anomaly(
            result=result, history=[prior1, prior2], tool_name="file.read"
        )
    ...
    def test_failed_status_triggers_error_condition(self):
        ...
        score = detect_anomaly(result=result, history=[], tool_name="exec.run")
        assert score.score == 1.0
        assert "error_status" in score.triggered_conditions
