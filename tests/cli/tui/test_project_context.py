...
def test_project_context_import_does_not_eagerly_import_textual_app() -> None:
    sys.modules.pop("openminion.cli.tui", None)
    sys.modules.pop("openminion.cli.tui.app", None)
    sys.modules.pop("openminion.cli.tui.project_context", None)

    module = importlib.import_module("openminion.cli.tui.project_context")
