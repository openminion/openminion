...
from openminion.cli.interactive.terminal.spinner import (
    SPINNER_FRAMES,
    THINKING_VERB,
    VERBS,
    Spinner,
...
def test_spinner_module_imports_only_neutral_dependencies() -> None:
    ...
    forbidden_prefixes = (
        "openminion.cli.interactive.terminal.streaming",
        "openminion.cli.interactive.terminal.shell",
        "openminion.cli.interactive.terminal.transcript",
        "openminion.cli.interactive.terminal.composer",
        "openminion.cli.interactive.terminal.status_line",
        "openminion.cli.interactive.terminal.overlays",
    )
