...
from openminion.cli.interactive.terminal.shell import _push_greeter
...
def test_greeter_contains_openminion_identity() -> None:
    ...
    assert "OpenMinion CLI" in out


def test_greeter_contains_interactive_terminal_label() -> None:
    out = _capture_greeter()
