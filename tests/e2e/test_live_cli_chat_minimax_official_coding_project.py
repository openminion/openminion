...
def test_live_minimax_m2_7_coding_builds_scratch_project() -> None:
    ...
    prompt = (
        ...
        "shell chaining. If exec.run reports that the command is still running, "
        "use exec.poll with its session_id until it finishes; do not repeat "
        "exec.run. Do not run pip or install the project; pytest runs "
