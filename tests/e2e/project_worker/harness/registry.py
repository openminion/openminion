...
PROJECT_WORKER_SCENARIOS: tuple[ProjectWorkerScenario, ...] = (
    ...
    ProjectWorkerScenario(
        ...
        suite="local",
        pytest_targets=("tests/e2e/tui/focus/test_local.py",),
    ...
    ProjectWorkerScenario(
        ...
        kind=ProjectWorkerScenarioKind.FOCUS_PTY,
        suite="live",
        pytest_targets=("tests/e2e/tui/focus/test_live_tools.py",),
        live=True,
    ...
    ProjectWorkerScenario(
        ...
        suite="deep",
        pytest_targets=("tests/e2e/tui/focus/test_live_complex.py",),
        live=True,
        complex=True,
    ...
    ProjectWorkerScenario(
        ...
        kind=ProjectWorkerScenarioKind.SOAK,
        suite="soak",
        pytest_targets=("tests/e2e/tui/focus/test_live_soak.py",),
        live=True,
        complex=True,
