...
def run_turn(
    *,
    ...
    runtime_factory: Callable[[str | None], RuntimeFacade] | None = None,
    ...
    if runtime is None and runtime_factory is None:
        raise RuntimeError("runtime or runtime_factory is required")
    active_runtime = runtime or runtime_factory(config_path)  # type: ignore[misc]
