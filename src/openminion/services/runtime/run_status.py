...
from openminion.services.runtime.config import RUN_STATUS_DEFAULT_SCAN_LIMIT
...
RUN_TERMINAL_COMPLETED = "completed"
RUN_TERMINAL_FAILED = "failed"
RUN_TERMINAL_BLOCKED = "blocked"
RUN_TERMINAL_NEEDS_HUMAN = "needs_human"
RUN_TERMINAL_BUDGET_EXHAUSTED = "budget_exhausted"
...
try:
    from openminion.modules.controlplane.runtime.client import (
        RunStatus as _ControlplaneRunStatus,
    )
except Exception:  # pragma: no cover - defensive fallback

    @dataclass(frozen=True)
    class _ControlplaneRunStatus:
        run_id: str
        state: str
        agent_id: str
        session_id: str
...
RunStatus = _ControlplaneRunStatus
