...
class SlashCommandMixin:
    ...
    def _slash_context(self, _args: str) -> None:
        from openminion.cli.tui.presentation.visible_parity import render_context_report

        self._push_system_body(render_context_report(self._runtime))

    def _slash_memory(self, _args: str) -> None:
        from openminion.cli.tui.presentation.visible_parity import render_memory_report

        self._push_system_body(render_memory_report(self._runtime))

    def _slash_skills(self, _args: str) -> None:
        from openminion.cli.tui.presentation.visible_parity import render_skills_report

        self._push_system_body(render_skills_report(self._runtime))

    def _slash_effort(self, args: str) -> None:
        from openminion.cli.tui.presentation.visible_parity import handle_effort_command
    ...
    def _slash_undo(self, args: str) -> None:
        from openminion.cli.tui.presentation.visible_parity import handle_undo_command
            ...
            self.query_one(FocusTranscript).push_message(
                ChatMessage(
                    ...
                    body=(
                        ...
                        "run `openminion tui` from another terminal."
                    ),
                )
            )
            return
            ...
            self.query_one(FocusTranscript).push_message(
                ChatMessage(
                    ...
                    body=(
                        ...
                        f"context ({exc}). Use `openminion tui` from "
