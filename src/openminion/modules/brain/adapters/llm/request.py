...
def _build_request_readiness_guidance_message(*, purpose: str, schema: type) -> str:
    ...
    return "\n".join(
        [
            ...
            "When the user explicitly requests a project handoff before changes, return that typed handoff before any execution tool call and do not perform the project work in the same turn.",
