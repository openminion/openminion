...
LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    'ADAPTIVE_CLOSURE_ENGINE_SINGLE_PASS': ('.contracts', 'ADAPTIVE_CLOSURE_ENGINE_SINGLE_PASS'),
    ...
    'PLAN_TOOL_ACTIONS_SCRATCHPAD_KEY': ('.plan_control', 'PLAN_TOOL_ACTIONS_SCRATCHPAD_KEY'),
    'PLAN_TOOL_ATTEMPTED_SCRATCHPAD_KEY': ('.plan_control', 'PLAN_TOOL_ATTEMPTED_SCRATCHPAD_KEY'),
    ...
    'ADAPTIVE_TERM_CORRECTION_BUDGET_EXHAUSTED': ('.contracts', 'ADAPTIVE_TERM_CORRECTION_BUDGET_EXHAUSTED'),
    'ADAPTIVE_TERM_DECOMPOSE_INVALID': ('.contracts', 'ADAPTIVE_TERM_DECOMPOSE_INVALID'),
    'ADAPTIVE_TERM_DECOMPOSE_REQUESTED': ('.contracts', 'ADAPTIVE_TERM_DECOMPOSE_REQUESTED'),
    'ADAPTIVE_TERM_DIRECT_TOOL_CLOSURE_FAILED': ('.contracts', 'ADAPTIVE_TERM_DIRECT_TOOL_CLOSURE_FAILED'),
    'ADAPTIVE_TERM_DISALLOWED_TOOL': ('.contracts', 'ADAPTIVE_TERM_DISALLOWED_TOOL'),
    'ADAPTIVE_TERM_DUPLICATE_TOOL_CALLS': ('.contracts', 'ADAPTIVE_TERM_DUPLICATE_TOOL_CALLS'),
    'ADAPTIVE_TERM_CONFIDENT_COMPLETE': ('.contracts', 'ADAPTIVE_TERM_CONFIDENT_COMPLETE'),
    'ADAPTIVE_TERM_FINALIZATION_BLOCKED': ('.contracts', 'ADAPTIVE_TERM_FINALIZATION_BLOCKED'),
    'ADAPTIVE_TERM_FINALIZATION_CONTRACT_MISSING': ('.contracts', 'ADAPTIVE_TERM_FINALIZATION_CONTRACT_MISSING'),
    'ADAPTIVE_TERM_FINALIZATION_INCOMPLETE': ('.contracts', 'ADAPTIVE_TERM_FINALIZATION_INCOMPLETE'),
    ...
    'ADAPTIVE_TERM_REQUESTED_TOOL_NOT_EXECUTED': ('.contracts', 'ADAPTIVE_TERM_REQUESTED_TOOL_NOT_EXECUTED'),
    'ADAPTIVE_TERM_TOOL_FAILURE_NO_RECOVERY': ('.contracts', 'ADAPTIVE_TERM_TOOL_FAILURE_NO_RECOVERY'),
    ...
    'AdaptiveToolLoopRuntimeUnavailableError': ('.contracts', 'AdaptiveToolLoopRuntimeUnavailableError'),
    'AdaptiveToolLoopState': ('.contracts', 'AdaptiveToolLoopState'),
    'CommandExecutionOutcome': ('.contracts', 'CommandExecutionOutcome'),
    'DefaultAdaptiveToolLoopLLMRuntime': ('.runtime', 'DefaultAdaptiveToolLoopLLMRuntime'),
    'TOOL_REQUEST_TOOL_NAME': ('.shortlisting', 'TOOL_REQUEST_TOOL_NAME'),
    'TOOL_SCHEMA_SHORTLIST_MAX_ACTIVE': ('.shortlisting', 'TOOL_SCHEMA_SHORTLIST_MAX_ACTIVE'),
    'TOOL_SCHEMA_SHORTLIST_THRESHOLD': ('.shortlisting', 'TOOL_SCHEMA_SHORTLIST_THRESHOLD'),
    ...
    'build_inactive_tool_directory_message': ('.shortlisting', 'build_inactive_tool_directory_message'),
