    ...
    hints = {
        ...
        "style_overrides": {
            "closure_gate_contract": (
                ...
                "load-bearing execution facts. Only submit_output is exposed during "
                "this judgment call; do not infer that execution tools were unavailable "
                "when the supplied execution facts show they ran. Do not treat one "
