    ...
    return {
        ...
        "style_overrides": {
            "success_memory_contract": (
                ...
                "For a procedure, use object content with a non-empty ordered "
                "steps list so a later session can reconstruct the workflow, and "
                "a tools list containing the canonical tool IDs actually used by "
                "that reusable procedure (empty when it needs no tools). "
