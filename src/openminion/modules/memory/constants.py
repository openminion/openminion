...
PROMOTABLE_MEMORY_CANDIDATE_STATUSES = frozenset(
    (MEMORY_CANDIDATE_STATUS_PROPOSED, MEMORY_CANDIDATE_STATUS_APPROVED)
)

MEMORY_UTILITY_DISPOSITION_REVIEW_KEEP = "review_keep"
MEMORY_UTILITY_DISPOSITION_REVIEW_DEMOTE = "review_demote"
MEMORY_UTILITY_DISPOSITION_REVIEW_ARCHIVE = "review_archive"
MEMORY_UTILITY_DISPOSITION_REVIEW_FORGET = "review_forget"
MEMORY_UTILITY_DISPOSITION_NEEDS_MORE_EVIDENCE = "needs_more_evidence"
MEMORY_UTILITY_DISPOSITIONS: tuple[str, ...] = (
