...
DEFAULT_TASK_NAME_MAX_CHARS: int = 60
TASK_SCHEDULER_HEARTBEAT_STALE_AFTER_SECONDS: float = 30.0
TASK_RUN_ERROR_DETAILS_MAX_JSON_CHARS: int = 2_000
DEFAULT_PROJECT_TURN_TIMEOUT_SECONDS: int = 300
DEFAULT_PROJECT_VERIFICATION_TIMEOUT_SECONDS: int = 120
PROJECT_VERIFICATION_OUTPUT_SUMMARY_MAX_CHARS: int = 4_000
...
TASK_INTERNAL_SCHEDULE_KEY = "_openminion_task_schedule"
