...
MODEL_TOOL_DISPLAY_NAME_MAP: dict[str, str] = {
    ...
    MODEL_HOST_INVENTORY_REPORT: "Create Host Inventory",
    MODEL_IP_PUBLIC: "Public IP",
    MODEL_IP_LOCAL: "Local IP",
    MODEL_BROWSER: "Browser",
    MODEL_BLOCKCHAIN_INSPECT: "Inspect Blockchain",
    MODEL_BLOCKCHAIN_DEBUG: "Debug Blockchain",
    MODEL_BLOCKCHAIN_PREPARE_TRANSACTION: "Prepare Blockchain Transaction",
    MODEL_BLOCKCHAIN_SEND_TRANSACTION: "Send Blockchain Transaction",
    MODEL_OPS_TARGET_LIST: "List Operations Targets",
    MODEL_OPS_TARGET_INSPECT: "Inspect Operations Target",
    MODEL_OPS_HOST_SNAPSHOT: "Inspect Host",
    MODEL_OPS_SERVICE_INSPECT: "Inspect Service",
    MODEL_OPS_LOGS_QUERY: "Query Logs",
    MODEL_OPS_NETWORK_INSPECT: "Inspect Network",
    MODEL_OPS_NETWORK_PORT_OWNER: "Inspect Port Owner",
    MODEL_OPS_PROCESS_INSPECT: "Inspect Process",
    MODEL_OPS_COMMAND_OBSERVE: "Observe Command",
    MODEL_OPS_COMMAND_PLAN: "Plan Operations Command",
    MODEL_OPS_COMMAND_RUN: "Run Operations Command",
    MODEL_OPS_FILE_READ: "Read Operations File",
    MODEL_OPS_JOB_INSPECT: "Inspect Operations Job",
    MODEL_OPS_JOB_CANCEL: "Cancel Operations Job",
    MODEL_CLOUD_SSM_INVENTORY: "Inspect Cloud Inventory",
    MODEL_CLOUD_SSM_COMMAND_STATUS: "Inspect Cloud Command",
    MODEL_OBSERVABILITY_PROM_RULES: "List Prometheus Rules",
    MODEL_OBSERVABILITY_PROM_ALERTS: "List Prometheus Alerts",
    MODEL_OBSERVABILITY_PROM_QUERY: "Query Prometheus",
    MODEL_OBSERVABILITY_TRACE_LOOKUP: "Look Up Trace",
    MODEL_SECURITY_SCAN_CODE: "Scan Source Code",
    MODEL_SECURITY_SCAN_DEPENDENCIES: "Scan Dependencies",
    MODEL_SECURITY_SCAN_ARTIFACT: "Scan Infrastructure Artifact",
    MODEL_SECURITY_SCAN_SECRETS: "Scan For Secrets",
    MODEL_SECURITY_PUBLISH_REPORT: "Publish Security Report",
    MODEL_K8S_WORKLOAD_GET: "Inspect Kubernetes Workload",
    MODEL_K8S_WORKLOAD_LIST: "List Kubernetes Workloads",
    MODEL_K8S_EVENTS_LIST: "List Kubernetes Events",
    MODEL_K8S_LOGS_GET: "Get Kubernetes Logs",
    MODEL_K8S_ROLLOUT_STATUS: "Inspect Kubernetes Rollout",
    MODEL_IAC_VALIDATE: "Validate Infrastructure",
    MODEL_IAC_PLAN_CREATE: "Create Infrastructure Plan",
    MODEL_IAC_PLAN_SHOW: "Show Infrastructure Plan",
    MODEL_IAC_PROVIDER_FACTS: "Inspect Infrastructure Provider",
    MODEL_GITOPS_APP_STATUS: "Inspect GitOps Application",
    MODEL_GITOPS_APP_DIFF: "Diff GitOps Application",
    MODEL_GITOPS_SOURCE_REVISION: "Inspect GitOps Revision",
    MODEL_GITOPS_DRIFT_INSPECT: "Inspect GitOps Drift",
    MODEL_CONFIG_ANSIBLE_CHECK: "Check Ansible Configuration",
    MODEL_CONFIG_ANSIBLE_FACTS: "Inspect Ansible Facts",
    MODEL_CONFIG_SALT_TEST: "Test Salt Configuration",
    MODEL_CONFIG_SALT_JOB_STATUS: "Inspect Salt Job",
    ...
    MODEL_GRAPH_QUERY: "Query Graph",
    MODEL_GRAPH_NEIGHBORHOOD: "Inspect Graph Neighborhood",
    MODEL_GRAPH_REFRESH: "Refresh Graph",
    ...
    MODEL_GITHUB_MERGE_PR: "Merge GitHub PR",
    MODEL_GITHUB_UPDATE_PR: "Update GitHub PR",
    MODEL_GITHUB_DISPATCH_WORKFLOW: "Dispatch GitHub Workflow",
    MODEL_GITHUB_LIST_WORKFLOW_RUNS: "List GitHub Workflow Runs",
    MODEL_GITHUB_CREATE_RELEASE: "Create GitHub Release",
    ...
    MODEL_GIT_FETCH: "Git Fetch",
    MODEL_GIT_PUSH: "Git Push",
    MODEL_GIT_TAG: "Git Tag",
